...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-object v1, p1, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lc/g;

    iget-boolean v2, p0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v0, v1, v2}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lc/g;Z)V
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lc/h;

    iget-boolean v2, p0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v1, p1, v2}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lc/h;Z)V
...
.method pushDataLater(ILc/h;IZ)V
    .locals 9
    ...
    .line 2
    invoke-interface {p2, v0, v1}, Lc/h;->b(J)V

    .line 3
    invoke-interface {p2, v5, v0, v1}, Lc/A;->read(Lc/f;J)J
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$6;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILc/f;IZ)V
...
.method public writeData(IZLc/f;J)V
    .locals 8
