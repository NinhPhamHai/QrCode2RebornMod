...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lc/A;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lc/A;[J)V
    :try_end_0
...
.method writeLengths(Lc/g;)V
    ...
    .line 2
    invoke-interface {p1, v5}, Lc/g;->writeByte(I)Lc/g;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lc/g;->c(J)Lc/g;
