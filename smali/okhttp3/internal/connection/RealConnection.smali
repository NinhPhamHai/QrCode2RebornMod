...
.method private connectSocket(II)V
    ...
    invoke-static {p1}, Lc/s;->a(Lc/z;)Lc/g;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lc/h;Lc/g;)V

    .line 3
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/h;

    invoke-interface {v1}, Lc/A;->timeout()Lc/C;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lc/C;->timeout(JLjava/util/concurrent/TimeUnit;)Lc/C;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/g;

    invoke-interface {v1}, Lc/z;->timeout()Lc/C;
    ...
    .line 11
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lc/A;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lc/A;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 20
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/h;

    invoke-interface {p1}, Lc/h;->a()Lc/f;
    ...
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/g;
...
.method private establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/h;

    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/g;

    invoke-virtual {p1, v0, v1, v2, v3}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lc/h;Lc/g;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIZ)V
    ...
    .line 22
    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/h;

    .line 23
    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/g;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lc/C;->timeout(JLjava/util/concurrent/TimeUnit;)Lc/C;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/g;
    ...
    invoke-direct {v0, p1, p2, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lc/h;Lc/g;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lc/h;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lc/g;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLc/h;Lc/g;Lokhttp3/internal/connection/StreamAllocation;)V
