...
.field final source:Lc/h;


# direct methods
.method constructor <init>(ZLc/h;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
    .locals 1
...
.method private readControlFrame()V
    ...
    .line 4
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lc/h;

    invoke-interface {v1, v0, v3, v4}, Lc/h;->a(Lc/f;J)V
    ...
    invoke-interface {v1, v3, v4, v2}, Lc/h;->read([BII)I
    ...
    invoke-virtual {v0, v5, v4, v1}, Lc/f;->write([BII)Lc/f;
    ...
    invoke-interface {v1, v0}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPong(Lc/i;)V
    ...
    invoke-interface {v1, v0}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPing(Lc/i;)V
...
.method private readHeader()V
    ...
    invoke-interface {v2}, Lc/A;->timeout()Lc/C;

    move-result-object v2

    invoke-virtual {v2}, Lc/C;->clearTimeout()Lc/C;

    .line 4
    :try_start_0
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lc/h;

    invoke-interface {v2}, Lc/h;->readByte()B
    ...
    invoke-interface {v3}, Lc/A;->timeout()Lc/C;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lc/C;->timeout(JLjava/util/concurrent/TimeUnit;)Lc/C;
    ...
    invoke-interface {v0}, Lc/h;->readLong()J
    ...
    invoke-interface {v0, v1}, Lc/h;->readFully([B)V
...
.method private readMessage(Lc/f;)V
    .locals 11
    ...
    invoke-interface {v2, v5, v0, v1}, Lc/h;->read([BII)I
    ...
    invoke-virtual {p1, v3, v0, v4}, Lc/f;->write([BII)Lc/f;
    ...
    invoke-interface {v2, p1, v0, v1}, Lc/A;->read(Lc/f;J)J
...
.method private readMessageFrame()V
    ...
    .line 4
    invoke-direct {p0, v2}, Lokhttp3/internal/ws/WebSocketReader;->readMessage(Lc/f;)V
    ...
    invoke-virtual {v2}, Lc/f;->o()Ljava/lang/String;
