...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lc/i;->c(Ljava/lang/String;)Lc/i;

    move-result-object p0

    invoke-virtual {p0}, Lc/i;->c()Lc/i;
...
.method static readInt(Lc/h;)I
    .locals 5

    .line 1
    :try_start_0
    invoke-interface {p0}, Lc/h;->h()J

    move-result-wide v0

    .line 2
    invoke-interface {p0}, Lc/h;->d()Ljava/lang/String;
...
.method get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lc/A;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lc/A;)V
    :try_end_1
