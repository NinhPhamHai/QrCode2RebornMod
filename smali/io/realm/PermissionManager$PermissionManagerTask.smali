...
.method private combineErrorCodes(Ljava/util/Map;)Lio/realm/ErrorCode;
    ...
    check-cast v1, Lio/realm/ObjectServerError;
...
.method private combineErrorMessage(Ljava/util/Map;)Ljava/lang/String;
    ...
    const-string v1, "Multiple errors occurred: "

    goto :goto_1

    :cond_1
    const-string v1, "Error occurred in Realm: "
...
.method private combineRealmErrors(Ljava/util/Map;)Lio/realm/ObjectServerError;
    ...
    invoke-direct {v1, p1, v0}, Lio/realm/ObjectServerError;-><init>(Lio/realm/ErrorCode;Ljava/lang/String;)V
...
.method protected final checkAndReportInvalidState()Z
    ...
    invoke-static {v0}, Lio/realm/PermissionManager;->access$2300(Lio/realm/PermissionManager;)Z
    ...
    invoke-static {v0}, Lio/realm/PermissionManager;->access$2400(Lio/realm/PermissionManager;)Z
    ...
    invoke-static {v0, v1}, Lio/realm/PermissionManager;->access$2402(Lio/realm/PermissionManager;Z)Z
    ...
    invoke-static {v3}, Lio/realm/PermissionManager;->access$700(Lio/realm/PermissionManager;)Lio/realm/Realm;
    ...
    invoke-static {v3}, Lio/realm/PermissionManager;->access$2400(Lio/realm/PermissionManager;)Z
    ...
    sget-object v3, Lio/realm/ErrorCode;->CLIENT_RESET:Lio/realm/ErrorCode;

    const-string v4, "The PermissionManager has been invalidated due to a server conflict. No further tasks can be scheduled. The app needs to be restarted to allow the PermissionManager to work again."

    invoke-direct {v2, v3, v4}, Lio/realm/ObjectServerError;-><init>(Lio/realm/ErrorCode;Ljava/lang/String;)V
    ...
    const-string v2, "Management Realm"
    ...
    const-string v2, "Permission Realm"
    ...
    const-string v2, "Default Permission Realm"
...
.method protected handleServerStatusChanges(Lio/realm/internal/permissions/BasePermissionApi;Ljava/lang/Runnable;)V
    ...
    invoke-static {p2}, Lio/realm/ErrorCode;->fromInt(I)Lio/realm/ErrorCode;
    ...
    invoke-direct {v0, p2, p1}, Lio/realm/ObjectServerError;-><init>(Lio/realm/ErrorCode;Ljava/lang/String;)V
    ...
    .line 10
    :cond_1
    sget-object p1, Lio/realm/ErrorCode;->UNKNOWN:Lio/realm/ErrorCode;
    ...
    const-string v1, "Illegal status code: "
    ...
    invoke-direct {v0, p1, p2}, Lio/realm/ObjectServerError;-><init>(Lio/realm/ErrorCode;Ljava/lang/String;)V
...
.method protected final notifyCallbackWithError(Lio/realm/ObjectServerError;)V
    ...
    .line 2
    invoke-static {v1}, Lio/realm/PermissionManager;->access$2500(Lio/realm/PermissionManager;)Lio/realm/SyncUser;
    ...
    const-string v1, "Error happened in PermissionManager for %s: %s"
    ...
    .line 5
    iget-object p1, p0, Lio/realm/PermissionManager$PermissionManagerTask;->permissionManager:Lio/realm/PermissionManager;
