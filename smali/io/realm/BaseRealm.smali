...
.method constructor <init>(Lio/realm/RealmConfiguration;Lio/realm/internal/OsSchemaInfo;)V
    ...
    invoke-static {v1}, Lio/realm/BaseRealm;->createMigrationCallback(Lio/realm/RealmMigration;)Lio/realm/internal/SharedRealm$MigrationCallback;
    ...
    .line 14
    invoke-virtual {v2, v1}, Lio/realm/internal/OsRealmConfig$Builder;->migrationCallback(Lio/realm/internal/SharedRealm$MigrationCallback;)Lio/realm/internal/OsRealmConfig$Builder;
    ...
    .line 16
    invoke-virtual {p2, v0}, Lio/realm/internal/OsRealmConfig$Builder;->initializationCallback(Lio/realm/internal/SharedRealm$InitializationCallback;)Lio/realm/internal/OsRealmConfig$Builder;

    move-result-object p2

    .line 17
    invoke-static {p2}, Lio/realm/internal/SharedRealm;->getInstance(Lio/realm/internal/OsRealmConfig$Builder;)Lio/realm/internal/SharedRealm;

    move-result-object p2

    iput-object p2, p0, Lio/realm/BaseRealm;->sharedRealm:Lio/realm/internal/SharedRealm;

    .line 18
    iput-boolean p1, p0, Lio/realm/BaseRealm;->shouldCloseSharedRealm:Z

    .line 19
    iget-object p1, p0, Lio/realm/BaseRealm;->sharedRealm:Lio/realm/internal/SharedRealm;

    iget-object p2, p0, Lio/realm/BaseRealm;->schemaChangedCallback:Lio/realm/internal/SharedRealm$SchemaChangedCallback;

    invoke-virtual {p1, p2}, Lio/realm/internal/SharedRealm;->registerSchemaChangedCallback(Lio/realm/internal/SharedRealm$SchemaChangedCallback;)V
...
.method static synthetic access$000(Lio/realm/RealmMigration;)Lio/realm/internal/SharedRealm$MigrationCallback;
    .locals 0

    .line 1
    invoke-static {p0}, Lio/realm/BaseRealm;->createMigrationCallback(Lio/realm/RealmMigration;)Lio/realm/internal/SharedRealm$MigrationCallback;
...
.method public writeCopyTo(Ljava/io/File;)V
    ...
    invoke-virtual {v0, p1, v1}, Lio/realm/internal/SharedRealm;->writeCopy(Ljava/io/File;[B)V
