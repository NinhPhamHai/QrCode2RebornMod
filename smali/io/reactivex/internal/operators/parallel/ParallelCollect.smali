...
.method reportError([Ld/a/c;Ljava/lang/Throwable;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 2
    invoke-static {p2, v2}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Ld/a/c;)V
...
.method public subscribe([Ld/a/c;)V
    ...
    invoke-direct {v4, v5, v3, v6}, Lio/reactivex/internal/operators/parallel/ParallelCollect$ParallelCollectSubscriber;-><init>(Ld/a/c;Ljava/lang/Object;Lio/reactivex/functions/BiConsumer;)V
    ...
    .line 7
    invoke-virtual {p0, p1, v0}, Lio/reactivex/internal/operators/parallel/ParallelCollect;->reportError([Ld/a/c;Ljava/lang/Throwable;)V
