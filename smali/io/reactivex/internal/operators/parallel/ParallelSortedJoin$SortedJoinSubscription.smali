...
# direct methods
.method constructor <init>(Ld/a/c;ILjava/util/Comparator;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelSortedJoin$SortedJoinSubscription;->actual:Ld/a/c;
...
.method drain()V
    ...
    .line 2
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/parallel/ParallelSortedJoin$SortedJoinSubscription;->actual:Ld/a/c;
    ...
    .line 12
    invoke-interface {v2, v15}, Ld/a/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 27
    :cond_8
    invoke-interface {v2, v13}, Ld/a/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 34
    invoke-interface {v2, v5}, Ld/a/c;->onError(Ljava/lang/Throwable;)V
