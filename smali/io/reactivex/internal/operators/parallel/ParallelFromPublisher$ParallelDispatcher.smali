...
# direct methods
.method constructor <init>([Ld/a/c;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Ld/a/c;
...
.method cancel(I)V
    ...
    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->s:Ld/a/d;
...
.method drainAsync()V
    ...
    .line 2
    iget-object v2, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Ld/a/c;
    ...
    .line 14
    invoke-interface {v3, v13}, Ld/a/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v12, v7}, Ld/a/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 25
    iget-object v11, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->s:Ld/a/d;

    int-to-long v12, v7

    invoke-interface {v11, v12, v13}, Ld/a/d;->request(J)V
    ...
    .line 27
    iget-object v0, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->s:Ld/a/d;
    ...
    .line 29
    invoke-interface {v4, v3}, Ld/a/c;->onError(Ljava/lang/Throwable;)V
...
.method drainSync()V
    ...
    invoke-interface {v11, v10}, Ld/a/c;->onNext(Ljava/lang/Object;)V
...
.method public onSubscribe(Ld/a/d;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->s:Ld/a/d;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->s:Ld/a/d;
...
.method setupSubscribers()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Ld/a/c;
    ...
    invoke-interface {v3, v5}, Ld/a/c;->onSubscribe(Ld/a/d;)V
