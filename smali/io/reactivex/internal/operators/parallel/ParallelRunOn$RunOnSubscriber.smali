...
# direct methods
.method constructor <init>(Ld/a/c;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->actual:Ld/a/c;
...
.method public onSubscribe(Ld/a/d;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->s:Ld/a/d;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->s:Ld/a/d;

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->actual:Ld/a/c;
...
.method public run()V
    ...
    .line 3
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->actual:Ld/a/c;
    ...
    .line 11
    invoke-interface {v3, v14}, Ld/a/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 16
    :cond_4
    invoke-interface {v3, v14}, Ld/a/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 17
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->s:Ld/a/d;

    move/from16 v16, v6

    int-to-long v5, v1

    invoke-interface {v13, v5, v6}, Ld/a/d;->request(J)V
    ...
    .line 23
    invoke-interface {v3, v5}, Ld/a/c;->onError(Ljava/lang/Throwable;)V
