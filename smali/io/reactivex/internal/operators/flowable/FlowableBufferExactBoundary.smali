...
# direct methods
.method public constructor <init>(Lio/reactivex/Flowable;Ld/a/b;Ljava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary;->boundary:Ld/a/b;
...
.method protected subscribeActual(Ld/a/c;)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary;->boundary:Ld/a/b;

    invoke-direct {v1, v2, p1, v3}, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;-><init>(Ld/a/c;Ljava/util/concurrent/Callable;Ld/a/b;)V
