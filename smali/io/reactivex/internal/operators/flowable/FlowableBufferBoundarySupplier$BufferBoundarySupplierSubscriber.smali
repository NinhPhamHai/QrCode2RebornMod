...
# direct methods
.method constructor <init>(Ld/a/c;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public bridge synthetic accept(Ld/a/c;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->accept(Ld/a/c;Ljava/util/Collection;)Z
...
.method public cancel()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Ld/a/d;
...
.method next()V
    ...
    .line 16
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Ld/a/d;
...
.method public onComplete()V
    ...
    invoke-static {v0, v1, v2, p0, p0}, Lio/reactivex/internal/util/QueueDrainHelper;->drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Ld/a/c;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
...
.method public onSubscribe(Ld/a/d;)V
    ...
    .line 2
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->s:Ld/a/d;
    ...
    .line 11
    invoke-interface {p1, v3, v4}, Ld/a/d;->request(J)V

    .line 12
    invoke-interface {v2, v1}, Ld/a/b;->subscribe(Ld/a/c;)V
    ...
    .line 16
    invoke-static {v2, v0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Ld/a/c;)V
