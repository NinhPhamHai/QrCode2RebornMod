...
# direct methods
.method public constructor <init>(Lio/reactivex/Flowable;Ld/a/b;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableSkipUntil;->other:Ld/a/b;
...
.method protected subscribeActual(Ld/a/c;)V
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableSkipUntil$SkipUntilMainSubscriber;-><init>(Ld/a/c;)V

    .line 2
    invoke-interface {p1, v0}, Ld/a/c;->onSubscribe(Ld/a/d;)V

    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSkipUntil;->other:Ld/a/b;
