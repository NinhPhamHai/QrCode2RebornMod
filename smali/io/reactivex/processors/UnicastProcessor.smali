...
# virtual methods
.method checkTerminated(ZZZLd/a/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Ld/a/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 11
    :cond_2
    invoke-interface {p4}, Ld/a/c;->onComplete()V
...
.method drain()V
    ...
    .line 4
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Ld/a/c;)V

    goto :goto_1

    .line 5
    :cond_1
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Ld/a/c;)V
...
.method drainRegular(Ld/a/c;)V
    ...
    .line 6
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLd/a/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    .line 7
    invoke-interface {v5, v15}, Ld/a/c;->onNext(Ljava/lang/Object;)V
